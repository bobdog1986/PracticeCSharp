...
namespace LeetCodeAlgo
{
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            var str1 = "qa";
            var str2 = "sq";
            var word1 = new string[] { "si", "go", "se", "cm", "so", "ph", "mt", "db", "mb", "sb", "kr", "ln",
                ...
                "no", "bi", "di", "hi", "qa", "pi", "os", "uh", "wm",
                "an", "me", "mo", "na", "la", "st", "er", "sc", "ne", "mn", "mi", "am", "ex", "pt", "io", "be",
            ...
            var result = anwser.Subsets(arr1);
