...
namespace LeetCodeAlgo
{
    public partial class Answer
    {
        ...
        // {
        //     int max = LcaDeepestLeaves_MaxDepth(root, 0);
        //     TreeNode res = null;
        //     int count = 0;
        //     LcaDeepestLeaves_LeafCount(root, 1, max, ref count, ref res);
        //     return res;
        // }
        // private int LcaDeepestLeaves_MaxDepth(TreeNode root, int depth)
        // {
        //     if (root == null) return depth;
        //     return Math.Max(LcaDeepestLeaves_MaxDepth(root.left, depth + 1), LcaDeepestLeaves_MaxDepth(root.right, depth + 1));
        // }

        // private int LcaDeepestLeaves_LeafCount(TreeNode root, int depth, int max, ref int count, ref TreeNode res)
        // {
        ...
        //     else
        //     {
        //         int leftCount = LcaDeepestLeaves_LeafCount(root.left, depth + 1, max, ref count, ref res);
        //         int rightCount = LcaDeepestLeaves_LeafCount(root.right, depth + 1, max, ref count, ref res);
        //         int curr = leftCount + rightCount;
        //         if (curr > count)
        //         {
        //             count = curr;
        //             res = root;
